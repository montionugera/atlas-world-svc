...
| **C3** | `canon.md:346` — *"War-scar monsters are Void-line"* — and `A0:272`, where void is the most-used element in the whole corpus and is **concentrated on the war ground**. Void was already behaving like a by-product of battle. This names the mechanism it was already obeying. |
...
| **C7** | `canon.md:293` — magic is cheap, ordinary, no shortage, no black market. Left exactly as it was. |
...
**Ashvale Front is the one thing the two towns cooperate on.** `canon.md:180-181` already says
