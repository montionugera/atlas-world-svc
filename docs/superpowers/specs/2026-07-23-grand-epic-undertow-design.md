...
| 2 | **The War Comes Home** | Open war between Embervale and Norhollow. Refugees flood Millcross; families separate. The player finds the first proof that "the incident" was staged (a salvaged caravan seal that matches neither side). Farrow the Forward (scout the player has bonded with) goes **missing in action** — presumed dead. |
...
| 4 | **The Truth Arrives Late** | The false flag is exposed — and it doesn't matter. The Broker twists the reveal into "enemy propaganda"; mobs burn the messengers. Embervale nearly repeats Cindervast (the Broker offers its council the relic weapon). **The Quartermaster of Millcross is gravely wounded** shielding refugees from a mob of her own neighbors — she survives, but can no longer run the camp; the player carries her work. **Farrow returns** — alive, scarred, changed (the story's PTSD arc lives here, not in a grave). The war's darkest hour is entirely human-made, and still no one the player loves most is taken. |
...
**Deaths (kept rare so each lands, all `diedAt` events):** Twin-Strike (act 1, exists) · the Clerk of Gildmark (act 3) · Thornveil War-Speaker (act 3). **Balanced by survivals:** the Quartermaster (wounded, lives), Farrow (missing → returns changed), at least one letter-thread couple reunited on stage in act 5. Theme-bible rules: named deaths must be causally human (orders, mobs, betrayal — monsters kill only unnamed characters), and **loss is never stacked** — no act takes more than one named character, and the most beloved are wounded or lost-and-found, not killed (user direction 2026-07-23: "too much loss" — hope must weigh as much as grief).
