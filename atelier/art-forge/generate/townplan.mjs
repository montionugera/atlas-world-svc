...
// atelier/art-forge is self-contained and this package has no dependency on
...
const USAGE =
  "usage: node atelier/art-forge/generate/townplan.mjs --plan <town-plan.json> --out <plan.png> [--width 1800]";
