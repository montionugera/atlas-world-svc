...
// atelier/art-forge/lib/brief-hash.mjs (node:crypto) — same canonicalization,
...
test("digestHex agrees with atelier/art-forge/lib/brief-hash.mjs", async () => {
  const { normalizeBrief, briefHash } = await import(
    "../../../atelier/art-forge/lib/brief-hash.mjs"
  );
  const brief = {
    id: "A1-ART-02",
    subject: "grove",
