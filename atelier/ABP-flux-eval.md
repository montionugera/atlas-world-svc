...
- **Prompt:** taken **byte-identical** from `atelier/art-forge/out/l1/briefs.tsv`, which is the same string the
...
- 4 images: `atelier/art-forge/out/flux/` (git-ignored)
- Comparison sheet: `atelier/art-forge/out/flux/_sheet.png` (2580×1272) — two subject rows, **T48 beside F-base
