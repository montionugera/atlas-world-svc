...
- **Briefs verbatim** from `atelier/art-forge/out/l1/briefs.tsv`, read by the runner, never retyped.
...
- **Nothing was intaken.** No manifest, `art-groups.json`, `content/`, or gate script was touched. No
  tooling under `atelier/art-forge/` was modified. Only this document is committed.

## Artifacts

All git-ignored, under `atelier/art-forge/out/anchorcmp/`:
...
- Norhollow block-in generator input: `atelier/art-forge/out/devtest/anchor/A1-ART-04.colour.json` and
