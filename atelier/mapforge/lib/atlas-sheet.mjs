// atelier/mapforge/lib/atlas-sheet.mjs — the world (atlas) sheet as a function.
//
...
// atelier/mapforge/tests/atlas-sheet.test.mjs measures the placed count from a
...
export function drawAtlasSheet({
  ...
  put(
    `<desc>Authored vector map drawn from content/spine/ (nodes + sheet-atlas.json) by atelier/mapforge/render-sheet.mjs. Not a generated image.</desc>`,
  );
  ...
  // repo uses (atelier/mapforge/lib/raster.mjs explicitly forbids the
