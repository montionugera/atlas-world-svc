// atelier/mapforge/lib/synthetic-sheet.mjs — the target-density canary.
//
...
function buildUncached({ repoRoot, fixture: injected = null, legendTier: legendTierArg = null }) {
  ...
  o.push(
    `<desc>Not geography, and it claims none. A synthetic sheet at the agreed target density (13 landmasses, 160 regions, 1740 landform instances, 340 labels) on the atlas sheet's own 400 km frame, built by atelier/mapforge/lib/synthetic-sheet.mjs so a render regression at scale is visible before the real world exists.</desc>`,
  );
  o.push("<defs>");
