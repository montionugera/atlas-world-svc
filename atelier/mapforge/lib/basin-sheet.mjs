// atelier/mapforge/lib/basin-sheet.mjs — the basin sheet as a function.
//
...
// is drawn from content/spine/ by atelier/mapforge/render-sheet.mjs. Nothing in
...
export function drawBasinSheet({ doc }) {
  ...
  put(
    `<desc>Authored vector map drawn from content/spine/ by atelier/mapforge/render-sheet.mjs. Not a generated image.</desc>`,
  );
  ...
  put(
    `<text x="${PANEL_X}" y="${r2(MAP_BOTTOM)}" font-size="11" font-style="italic" fill="${C.inkSoft}">` +
      `by atelier/mapforge/render-sheet.mjs — authored vector, not generated</text>`,
  );
