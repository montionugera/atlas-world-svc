// atelier/mapforge/lib/ink.mjs — G-BIOME-INK.
//
...
export function checkBiomeInk(opts) {
  ...
  for (const k of TERRAIN_KINDS)
    if (!FILL_FOR[k])
      problems.push(
        `G-BIOME-INK: terrain kind "${k}" is in TERRAIN_KINDS but has no entry in FILL_FOR (atelier/mapforge/lib/draft.mjs) — it will render as blank parchment`,
      );
