// atelier/mapforge/lib/passes/sea-level.mjs — P3: the land/sea threshold.
//
...
export function selectSeaLevelByRank({ elev, targetLandCells }) {
  ...
  if (seaLevel < LAND_FLOOR_F32)
    throw new Error(
      ...
      `content/world/premises/*.json footprint radii (re-run atelier/mapforge/fit-premises.mjs, which holds ` +
