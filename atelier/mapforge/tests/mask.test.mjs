// atelier/mapforge/tests/mask.test.mjs — Task 3: the thirteen premises, P1, P2, P2b.
//
...
test("GOLDEN: the fit — every footprint is the PLAN's, re-materialised at the fitted scale", () => {
  ...
  //
  // So the procedure is committed (atelier/mapforge/fit-premises.mjs) and this is
