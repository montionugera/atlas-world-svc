// atelier/mapforge/tests/_source-scan.mjs — the ONE comment-stripper the two
// determinism scans share.
//
// NOT a *.test.mjs file, deliberately: `node --test atelier/mapforge/tests/*.test.mjs`
...
//
// blanked the whole of atelier/mapforge/generate-world.mjs. Reproduced against
...
// atelier/mapforge/ no longer PARSED after stripping — arcs, glyphs, labels,
...
//   * `atelier/mapforge/<newdir>/*.mjs` — the top-level scan was deliberately
