...
//
// node:zlib is banned in atelier/mapforge/lib/texture-bake.mjs and NOT here. A
...
const MODULE = join(ROOT, "atelier/mapforge/lib/texture-bake.mjs");
...
test("GENERATOR_VERSION has exactly ONE definition in the repo", () => {
  ...
  const hits = files
    ...
    .sort();
  assert.deepEqual(hits, ["atelier/mapforge/lib/version.mjs"]);
});
