// atelier/mapforge/tests/helpers/promote-fixture.mjs — the shared scratch tree
...
export const GEN = join(ROOT, "atelier/mapforge/generate-world.mjs");
 ...
 * the whole of atelier/mapforge/ outside tests/ — because a cache key that is a
...
function inputDigest() {
  ...
  walk(join(ROOT, "atelier/mapforge"), "atelier/mapforge/", (n) => n === "tests");
...
export function cachedRun() {
  ...
  if (!existsSync(join(dir, "manifest.json"))) {
    ...
    // files, so without this a day of editing atelier/mapforge/ leaves dozens
