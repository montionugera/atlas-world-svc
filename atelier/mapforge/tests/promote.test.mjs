// atelier/mapforge/tests/promote.test.mjs — Plan C Task 12.
//
...
function plantStaleNode(repo) {
  const doc = {
    ...
    title: "Stale Probe",
    provenance: { authored: "hand", generator: null, source: "atelier/mapforge/tests/promote.test.mjs" },
    frozen: false,
...
test("promoteWorld never shells out to git", () => {
  const src = readFileSync(join(ROOT, "atelier/mapforge/promote-world.mjs"), "utf8");
