...
· **Consumes:** the `environment.segment` block in `atelier/art-forge/forge.config.json` (Task 2
wiring) and the Millcross segment control map `atelier/art-forge/out/control/segment/A1-ART-02-segment.png`
...
euler / simple, 1280×832. Images in `atelier/art-forge/out/env/A1-ART-02-segment-seed12345-s*.png`.
