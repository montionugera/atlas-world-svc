...
// ── spine → colyseus-server/src/config/generated/mapDimensions.ts
//    (G-EMIT-DRIFT, Phase 4 mirror #3). Generated TypeScript imported at
//    build time — never a JSON file read at room create (GameState's
//    constructor is synchronous; GameRoom.onCreate has no try/catch).
