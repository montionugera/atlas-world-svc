...
| **the Iron Regent** (`char-iron-regent`) | POWER | Power that calls itself protection. | Ashen Vigil register: clipped command; frames every seizure of authority as logistics and necessity, never ambition. | "Emergency powers aren't a betrayal of the Countess's rule. They're what's left of it, kept alive." |
| **the Bell-Keeper** (`char-the-bell-keeper`) | LOVE | Love is both the story's light and its knife. | Ashen Vigil register: apologetic and precise — speaks in readings and sealings, guilt threaded under procedure; only softens naming his daughter. | "I sealed the proclamation the Broker wrote about the first caravan, word for word, and burned the true one before it ever reached the square. My own hand. My own seal. That's a whole town believing a lie, and I did it on purpose." |
...
| **the Ash Prophet** (`char-the-ash-prophet`) | CHAOS | "The fallen city is the only honest one — everything should fall." | Ashen Vigil register: sermon cadence, short declarative bursts, addresses crowds rather than individuals, treats destruction as liturgy. | "Cindervast didn't lie about what it was. Every wall still standing around you is lying to your face." |
